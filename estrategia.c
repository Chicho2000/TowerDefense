...
void disponer_con_backtracking(Nivel* nivel, Mapa* mapa) {
    ...
    torre,cant_validas,mapa->cant_torres,
    nivel->enemigos->vida_inicial,torres);
...
void disponer_custom(Nivel* nivel, Mapa* mapa) {
    ...
    int cant_validas = posiciones_validas(
        posiciones_validas_torre, mapa->casillas,
    ...
    // Ordenar el arreglo de mayor a menor por cant_casillas_en_rango usando quicksort
